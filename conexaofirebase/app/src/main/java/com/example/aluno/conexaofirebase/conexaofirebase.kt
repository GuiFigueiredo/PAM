package com.example.aluno.conexaofirebase
...
class conexaofirebase : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_conexaofirebase)
    ...
    private fun formIsValid() : Boolean {
        ...
        if (email.equals("") || pass.equals("")) {
            toast("o email ou senha estao em branco ...")
            ret = false
